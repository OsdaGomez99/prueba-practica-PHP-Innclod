                            ...
                            <div class="form-group p-2">
                                <div class="row row-cols-2">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" name="DOC_NOMBRE" id="nombre" placeholder="" maxlength="60" oninput="transformarMayusculas(this)">
                                    </div>
                                    <div class="col">
                                        <label for="contenido">Contenido</label>
                                        <textarea type="textarea" class="form-control" name="DOC_CONTENIDO" id="contenido" placeholder="" maxlength="4000"></textarea>
                                    </div>
                                    <div class="col">
